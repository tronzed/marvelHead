  ...
  return (
    <>
      ...
      <>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-12 col-sm-6 col-lg-4">
                <div className="about-us-thumbnail mb-50 " data-wow-delay="100ms">
                  <span className="line" />
              ...
              {/* About Us Thumbnail */}
              <div className="col-12 col-sm-6 col-lg-4">
                <div className="about-us-thumbnail mb-50 " data-wow-delay="400ms">
                  <span className="line" />
              ...
              <div className="col-12 col-lg-4">
                <div className="about-us-content mb-50 " data-wow-delay="700ms">
            ...
            <div className="service-area mt-80">
              <div className="row">
                ...
                <div className="col-12 col-sm-6 col-lg-3">
                  <div className="single-service-area mb-50 " data-wow-delay="100ms">
                ...
                {/* Single Service Area */}
                <div className="col-12 col-sm-6 col-lg-3">
                  <div className="single-service-area mb-50 " data-wow-delay="300ms">
                ...
                {/* Single Service Area */}
                <div className="col-12 col-sm-6 col-lg-3">
                  <div className="single-service-area mb-50 " data-wow-delay="500ms">
                ...
                {/* Single Service Area */}
                <div className="col-12 col-sm-6 col-lg-3">
                  <div className="single-service-area mb-50 " data-wow-delay="700ms">
              ...
              <div className="row">
                <div className="col-12">
                  <div className="tab-content" id="mona_modelTabContent">
                    ...
                    >
                      {/* All Model Slide */}
                      <div className="mona-all-model-slides">
                        <div className="row">
        ...
        {/* ***** CTA Area End ***** */}
        {/* ***** Blog Area Start ***** */}
        <section className="mona-blog-area mb-50 section-padding-80-0">
          <div className="container">
            <div className="row">
              {/* Section Heading */}
              <div className="col-12">
            ...
            <div className="row">
              {/* Single Blog Post */}
              <div className="col-12 col-lg-4">
                <div className="single-blog-post mb-30 " data-wow-delay="100ms">
                  <div className="post-thumbnail slide-posts">
                    <a href="#">
                  ...
                  <div className="post-content">
                    ...
                    <span className="post-date">30 Aug 2018</span>
                  </div>
                </div>
              </div>
              <div className="col-12 col-lg-8">
                <div className="row">
                  ...
                  <div className="col-12">
                    <div
                      className="single-blog-post featured-post mb-30 "
                  ...
                  <div className="col-12 col-sm-6">
                    <div className="single-blog-post mb-30 " data-wow-delay="500ms">
                      <div className="post-thumbnail">
                        <a href="#">
                  ...
                  {/* Single Blog Post */}
                  <div className="col-12 col-sm-6">
                    <div className="single-blog-post mb-30 " data-wow-delay="700ms">
                      <div className="post-thumbnail">
                        <a href="#">
